...
const policies: Record<GameId, DifficultyPolicy> = {
  ...
  ga_auditory_lab: {
    ...
    targetAccuracyLow: 0.65,
    levelMap: {
        1: { mechanic_config: { noiseLevel: 0, responseWindowMs: 3000 }, content_config: { neutral: { sub_variant: "gap_detection", params: { gapMs: 120 } }, math: { sub_variant: "phoneme_discrimination", params: { noise_level: 0, pairs: ['p', 'b'] } }, music: { sub_variant: 'pitch_discrimination', params: { freqDelta: 50 } }, verbal: { sub_variant: 'phoneme_discrimination', params: { noise_level: 0, pairs: ['p', 'b'] } }, spatial: { sub_variant: 'sound_localization', params: { pan: [-1, 1], gain: [1, 1] } } } },
        2: { mechanic_config: { noiseLevel: 0, responseWindowMs: 3000 }, content_config: { neutral: { sub_variant: "gap_detection", params: { gapMs: 100 } }, math: { sub_variant: "phoneme_discrimination", params: { noise_level: 0, pairs: ['t', 'd'] } }, music: { sub_variant: 'rhythm_matching', params: { complexity: 1 } }, verbal: { sub_variant: 'phoneme_discrimination', params: { noise_level: 0, pairs: ['p', 'b', 't', 'd'] } }, spatial: { sub_variant: 'sound_localization', params: { pan: [-0.5, 0.5], gain: [1, 1] } } } },
        // ... and so on
