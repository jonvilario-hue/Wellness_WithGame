...
export const chcDomains: { 
  ...
  { key: 'Ga', id: 'ga_auditory_lab', name: '(Ga) Auditory Processing', description: 'Analyze and distinguish sounds', gameTitle: 'Auditory Processing Lab', tasks: ['gap_detection', 'frequency_discrimination', 'figure_ground', 'rhythm_discrimination'], supportsMath: false, supportsMusic: false },
  { key: 'Glr', id: 'glr_fluency_storm', name: '(Glr) Long-Term Retrieval', description: 'Builds rapid word association and memory recall pathways', gameTitle: 'Glr Retrieval Trainer', tasks: ['associative_chain', 'spaced_retrieval', 'category_sprint'], supportsMath: false, supportsMusic: false },
