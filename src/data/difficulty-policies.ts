...
const policies: Partial<Record<GameId, DifficultyPolicy>> = {
  ...
  gf_pattern_matrix: {
    ...
    levelMap: {
      ...
      6: { mechanic_config: { gridSize: "2x2", distractor_similarity: "medium" }, content_config: { neutral: {}, math: {}, music: {}, verbal: {}, spatial: {}, eq: { sub_variant: 'emotion_matrix', params: { rule_family: ['Emotion Blending', 'Context Negation'], distractor_count: 5 } } } },
      7: { mechanic_config: { gridSize: "3x3", distractor_similarity: "medium" }, content_config: { neutral: {}, math: {}, music: {}, verbal: {}, spatial: {}, eq: { sub_variant: 'emotion_matrix', params: { rule_family: ['Intensity', 'Valence Alternation', 'Emotion Blending'], distractor_count: 6 } } } },
      8: { mechanic_config: { gridSize: "3x3", distractor_similarity: "medium" }, content_config: { neutral: {}, math: {}, music: {}, verbal: {}, spatial: {}, eq: { sub_variant: 'emotion_matrix', params: { rule_family: ['Arousal Shift', 'Context Negation', 'Emotion Blending'], distractor_count: 6 } } } },
    }
  },
  gv_visual_lab: {
  ...
  gc_verbal_inference: {
    ...
    levelMap: {
      ...
      4: { mechanic_config: { timeLimit: 20000 }, content_config: { math: { sub_variant: 'knowledge_retrieval', params: { question_level: 2 } }, music: { sub_variant: 'knowledge_retrieval', params: { question_level: 2 } }, spatial: { sub_variant: 'spatial_concept_map', params: { nodeCount: 12, abstraction: 'abstract' } }, eq: { sub_variant: 'novel_concept_learning', params: { concept_complexity: 2 } } } },
      5: { mechanic_config: { timeLimit: 20000 }, content_config: { math: { sub_variant: 'knowledge_retrieval', params: { question_level: 2 } }, music: { sub_variant: 'knowledge_retrieval', params: { question_level: 3 } }, spatial: { sub_variant: 'spatial_concept_map', params: { nodeCount: 12, abstraction: 'abstract' } }, eq: { sub_variant: 'novel_concept_learning', params: { concept_complexity: 3 } } } },
      6: { mechanic_config: { timeLimit: 20000 }, content_config: { math: { sub_variant: 'knowledge_retrieval', params: { question_level: 2 } }, music: { sub_variant: 'knowledge_retrieval', params: { question_level: 3 } }, spatial: { sub_variant: 'spatial_concept_map', params: { nodeCount: 15, abstraction: 'abstract' } }, eq: { sub_variant: 'novel_concept_learning', params: { concept_complexity: 3 } } } },
      7: { mechanic_config: { timeLimit: 20000 }, content_config: { math: { sub_variant: 'knowledge_retrieval', params: { question_level: 3 } }, music: { sub_variant: 'knowledge_retrieval', params: { question_level: 4 } }, spatial: { sub_variant: 'spatial_concept_map', params: { nodeCount: 15, abstraction: 'abstract' } }, eq: { sub_variant: 'novel_concept_learning', params: { concept_complexity: 4 } } } },
