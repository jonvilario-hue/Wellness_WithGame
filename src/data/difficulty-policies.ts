...
const policies: Record<GameId, DifficultyPolicy> = {
  ...
  ga_auditory_lab: {
    ...
    targetAccuracyLow: 0.65,
    levelMap: {
      1: { mechanic_config: {}, content_config: { music: { params: { pitchDelta: 400 } }, math: { sub_variant: "magnitude_comparison", params: { digits: 2, speechRate: 1.0, pitchDelta: 100 } } } },
      2: { mechanic_config: {}, content_config: { music: { params: { pitchDelta: 300 } }, math: { sub_variant: "magnitude_comparison", params: { digits: 2, speechRate: 1.2, pitchDelta: 90 } } } },
      3: { mechanic_config: {}, content_config: { music: { params: { pitchDelta: 200 } }, math: { sub_variant: "magnitude_comparison", params: { digits: 3, speechRate: 1.0, pitchDelta: 80 } } } },
      4: { mechanic_config: {}, content_config: { music: { params: { pitchDelta: 150 } }, math: { sub_variant: "magnitude_comparison", params: { digits: 3, speechRate: 1.2, pitchDelta: 70 } } } },
      5: { mechanic_config: {}, content_config: { music: { params: { pitchDelta: 100 } }, math: { sub_variant: "magnitude_comparison", params: { digits: 3, speechRate: 1.5, pitchDelta: 60 } } } },
      6: { mechanic_config: {}, content_config: { music: { params: { pitchDelta: 75 } }, math: { sub_variant: "magnitude_comparison", params: { digits: 4, speechRate: 1.2, pitchDelta: 50 } } } },
      7: { mechanic_config: {}, content_config: { music: { params: { pitchDelta: 50 } }, math: { sub_variant: "magnitude_comparison", params: { digits: 4, speechRate: 1.5, pitchDelta: 40 } } } },
  ...
  glr_fluency_storm: {
    ...
    targetAccuracyLow: 0.60,
    levelMap: {
      1: { mechanic_config: {}, content_config: { music: { sub_variant: 'spaced_retrieval', params: { pairs: 3, distractorDuration: 10 } }, math: { sub_variant: 'spaced_retrieval', params: { pairs: 4, distractorDuration: 10 } }, neutral: { params: { category: "broad_concrete" } }, verbal: { sub_variant: 'category_sprint', params: { category: 'Animals' } }, spatial: { sub_variant: 'route_retrieval', params: { map_complexity: 1 } } } },
      2: { mechanic_config: {}, content_config: { music: { sub_variant: 'spaced_retrieval', params: { pairs: 3, distractorDuration: 15 } }, math: { sub_variant: 'spaced_retrieval', params: { pairs: 4, distractorDuration: 15 } } } },
      3: { mechanic_config: {}, content_config: { music: { sub_variant: 'spaced_retrieval', params: { pairs: 4, distractorDuration: 15 } }, math: { sub_variant: 'spaced_retrieval', params: { pairs: 5, distractorDuration: 15 } } } },
      4: { mechanic_config: {}, content_config: { music: { sub_variant: 'spaced_retrieval', params: { pairs: 4, distractorDuration: 20 } }, math: { sub_variant: 'spaced_retrieval', params: { pairs: 5, distractorDuration: 20 } } } },
      5: { mechanic_config: {}, content_config: { music: { sub_variant: 'spaced_retrieval', params: { pairs: 5, distractorDuration: 20 } }, math: { sub_variant: 'spaced_retrieval', params: { pairs: 6, distractorDuration: 20 } } } },
      6: { mechanic_config: {}, content_config: { music: { sub_variant: 'spaced_retrieval', params: { pairs: 5, distractorDuration: 25 } }, math: { sub_variant: 'spaced_retrieval', params: { pairs: 6, distractorDuration: 25 } } } },
      7: { mechanic_config: {}, content_config: { music: { sub_variant: 'spaced_retrieval', params: { pairs: 6, distractorDuration: 25 } }, math: { sub_variant: 'spaced_retrieval', params: { pairs: 7, distractorDuration: 25 } } } },
      8: { mechanic_config: {}, content_config: { music: { sub_variant: 'spaced_retrieval', params: { pairs: 6, distractorDuration: 30 } }, math: { sub_variant: 'spaced_retrieval', params: { pairs: 7, distractorDuration: 30 } } } },
      9: { mechanic_config: {}, content_config: { music: { sub_variant: 'spaced_retrieval', params: { pairs: 7, distractorDuration: 30 } }, math: { sub_variant: 'spaced_retrieval', params: { pairs: 8, distractorDuration: 30 } } } },
      10: { mechanic_config: {}, content_config: { music: { sub_variant: 'spaced_retrieval', params: { pairs: 7, distractorDuration: 35 } }, math: { sub_variant: 'spaced_retrieval', params: { pairs: 8, distractorDuration: 35 } } } },
    }
  },
  gc_verbal_inference: {
