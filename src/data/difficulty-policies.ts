...
const policies: Partial<Record<GameId, DifficultyPolicy>> = {
  ...
  ef_focus_switch: {
    ...
    levelMap: {
      1: { mechanic_config: { switchInterval: 8, noGo: false, responseWindowMs: 3000, switchProbability: 0 }, content_config: { neutral: { params: { ruleCount: 2, cueType: "explicit_text" } }, math: { params: { ruleCount: 2, rules: ["parity", "magnitude"] } }, music: { sub_variant: 'auditory_stroop', params: { incongruent_ratio: 0.25, high_pitch_hz: 440, low_pitch_hz: 220 } }, verbal: { sub_variant: 'semantic_phonetic_shift', params: { rules: ['rhyme', 'category'], switch_interval: 10 } }, spatial: { sub_variant: 'perspective_shift', params: { cue: 'explicit' } } } },
      2: { mechanic_config: { switchInterval: 8, noGo: false, responseWindowMs: 2800, switchProbability: 0.1 }, content_config: { math: { params: { ruleCount: 2, rules: ["parity", "magnitude"] } }, music: { sub_variant: 'auditory_stroop', params: { incongruent_ratio: 0.25, high_pitch_hz: 440, low_pitch_hz: 261 } } } },
      3: { mechanic_config: { switchInterval: 8, noGo: false, responseWindowMs: 2800, switchProbability: 0.15 }, content_config: { math: { params: { ruleCount: 2, rules: ["parity", "magnitude"] } }, music: { sub_variant: 'auditory_stroop', params: { incongruent_ratio: 0.30, high_pitch_hz: 440, low_pitch_hz: 293 } } } },
      4: { mechanic_config: { switchInterval: 5, noGo: false, responseWindowMs: 2500, switchProbability: 0.2 }, content_config: { math: { params: { ruleCount: 2, rules: ["parity", "magnitude"] } }, music: { sub_variant: 'auditory_stroop', params: { incongruent_ratio: 0.30, high_pitch_hz: 440, low_pitch_hz: 330 } } } },
      5: { mechanic_config: { switchInterval: 5, noGo: false, responseWindowMs: 2500, switchProbability: 0.25 }, content_config: { math: { params: { ruleCount: 2, rules: ["parity", "magnitude"] } }, music: { sub_variant: 'auditory_stroop', params: { incongruent_ratio: 0.35, high_pitch_hz: 440, low_pitch_hz: 349 } } } },
      6: { mechanic_config: { switchInterval: 4, noGo: false, responseWindowMs: 2200, switchProbability: 0.3 }, content_config: { math: { params: { ruleCount: 2, rules: ["parity", "magnitude"] } }, music: { sub_variant: 'auditory_stroop', params: { incongruent_ratio: 0.35, high_pitch_hz: 440, low_pitch_hz: 370 } } } },
      7: { mechanic_config: { switchInterval: 4, noGo: true, noGoWaitMs: 1500, responseWindowMs: 2200, switchProbability: 0.3 }, content_config: { math: { params: { ruleCount: 2, rules: ["parity", "magnitude"] } }, music: { sub_variant: 'auditory_stroop', params: { incongruent_ratio: 0.40, high_pitch_hz: 440, low_pitch_hz: 392 } } } },
      8: { mechanic_config: { switchInterval: 3, noGo: true, noGoWaitMs: 1500, responseWindowMs: 2000, switchProbability: 0.3 }, content_config: { math: { params: { ruleCount: 2, rules: ["parity", "magnitude"] } }, music: { sub_variant: 'auditory_stroop', params: { incongruent_ratio: 0.40, high_pitch_hz: 440, low_pitch_hz: 392 } } } },
      9: { mechanic_config: { switchInterval: 3, noGo: true, noGoWaitMs: 1400, responseWindowMs: 1800, switchProbability: 0.35 }, content_config: { math: { params: { ruleCount: 2, rules: ["parity", "magnitude"] } }, music: { sub_variant: 'auditory_stroop', params: { incongruent_ratio: 0.45, high_pitch_hz: 440, low_pitch_hz: 415 } } } },
      10: { mechanic_config: { switchInterval: 2, noGo: true, noGoWaitMs: 1300, responseWindowMs: 1800, switchProbability: 0.4 }, content_config: { math: { params: { ruleCount: 2, rules: ["parity", "magnitude"] } }, music: { sub_variant: 'auditory_stroop', params: { incongruent_ratio: 0.45, high_pitch_hz: 440, low_pitch_hz: 415 } } } },
    }
  }
};
