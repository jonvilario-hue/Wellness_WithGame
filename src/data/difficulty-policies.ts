...
const policies: Record<GameId, DifficultyPolicy> = {
  gwm_dynamic_sequence: {
    ...
    levelMap: {
      ...
      6: { mechanic_config: { sequenceLength: 6, displayTimeMs: 1500, visualDisplayTimeMs: 1800 }, content_config: { neutral: {}, math: {}, music: {}, verbal: {}, spatial: {} } },
  ...
  gs_rapid_code: {
    ...
    levelMap: {
      ...
      2: { mechanic_config: { responseWindowMs: 2500, distractorCount: 3 }, content_config: { neutral: { params: { complexity: "simple" } }, math: { sub_variant: "magnitude_comparison", params: { formats: ['decimal'], decimal_places: 2 } }, music: { sub_variant: 'interval_compare', params: { types: ['P5', 'octave'], direction: true }}, verbal: { sub_variant: 'synonym_match', params: { word_length: 4, frequency_min: 7 } }, spatial: { sub_variant: 'rapid_rotation', params: { shape: 'simple', rotation: 'cardinal' }} } },
