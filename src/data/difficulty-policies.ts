...
const policies: Partial<Record<GameId, DifficultyPolicy>> = {
  ...
  gv_visual_lab: {
    ...
    targetAccuracyLow: 0.65,
    levelMap: {
      1: { mechanic_config: {}, content_config: { logic: { sub_variant: 'flowchart_tracer', params: {} }, eq: { params: { angles: [90, 180, 270], emotionFoil: false, distractorCount: 2 } }, neutral: { sub_variant: "mental_rotation", params: { angles: [90, 180, 270] } }, math: { sub_variant: "balance_puzzle", params: { shapeCount: 3, maxWeight: 5, equationTerms: 4 } }, music: { sub_variant: "contour_match", params: { measures: ['q_q_h', 'h_q_q'], distractorCount: 1 } }, verbal: { sub_variant: 'typographic_search', params: { type: 'compound', complexity: 1 } }, spatial: { sub_variant: 'spatial_assembly', params: { pieceCount: 5, complexity: 1 } } } },
      2: { mechanic_config: {}, content_config: { logic: { sub_variant: 'flowchart_tracer', params: {} }, eq: { params: { angles: [45, 90, 135, 180], emotionFoil: false, distractorCount: 2 } }, neutral: { sub_variant: "mental_rotation", params: { angles: [90, 180, 270] } }, math: { sub_variant: "balance_puzzle", params: { shapeCount: 3, maxWeight: 7, equationTerms: 5 } }, music: { sub_variant: "contour_match", params: { measures: ['q_q_h', 'h_q_q'], distractorCount: 2 } }, verbal: { sub_variant: 'typographic_search', params: { type: 'compound', complexity: 2 } }, spatial: { sub_variant: 'spatial_assembly', params: { pieceCount: 6, complexity: 1 } } } },
      3: { mechanic_config: {}, content_config: { logic: { sub_variant: 'flowchart_tracer', params: {} }, eq: { params: { angles: [45, 90, 135, 180, 225, 270], emotionFoil: true, distractorCount: 4 } }, neutral: { sub_variant: "mental_rotation", params: { angles: "free" } }, math: { sub_variant: "balance_puzzle", params: { shapeCount: 4, maxWeight: 7, equationTerms: 5 } }, music: { sub_variant: "contour_match", params: { measures: ['q_q_h', 'h_q_q', 'e_e_q_q'], distractorCount: 2 } }, verbal: { sub_variant: 'typographic_search', params: { type: 'affixes', complexity: 1 } }, spatial: { sub_variant: 'spatial_assembly', params: { pieceCount: 7, complexity: 2 } } } },
      4: { mechanic_config: {}, content_config: { logic: { sub_variant: 'flowchart_tracer', params: {} }, eq: { params: { angles: [45, 90, 135, 180, 225, 270, 315], emotionFoil: true, distractorCount: 4 } }, neutral: { sub_variant: "mental_rotation", params: { angles: "free" } }, math: { sub_variant: "balance_puzzle", params: { shapeCount: 4, maxWeight: 9, equationTerms: 6 } }, music: { sub_variant: "contour_match", params: { measures: ['q_q_h', 'h_q_q', 'e_e_q_q'], distractorCount: 3 } }, verbal: { sub_variant: 'typographic_search', params: { type: 'affixes', complexity: 2 } }, spatial: { sub_variant: 'spatial_assembly', params: { pieceCount: 8, complexity: 2 } } } },
      5: { mechanic_config: {}, content_config: { logic: { sub_variant: 'flowchart_tracer', params: {} }, eq: { params: { angles: [45, 90, 135, 180, 225, 270, 315], emotionFoil: true, distractorCount: 4 } }, neutral: { sub_variant: "mental_rotation", params: { angles: "free", reflection: true } }, math: { sub_variant: "balance_puzzle", params: { shapeCount: 5, maxWeight: 9, equationTerms: 6 } }, music: { sub_variant: "spectrogram_match", params: { timbres: ['sine', 'square'], distractorCount: 3 } }, verbal: { sub_variant: 'visual_scan', params: { grid_size: 5, target_length: 3 } }, spatial: { sub_variant: 'spatial_assembly', params: { pieceCount: 9, complexity: 3 } } } },
