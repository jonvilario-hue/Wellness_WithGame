...
const policies: Record<GameId, DifficultyPolicy> = {
  ...
  gv_visual_lab: {
    ...
    targetAccuracyLow: 0.65,
    levelMap: {
      1: { mechanic_config: {}, content_config: { math: { sub_variant: "spatial_assembly" } } },
      2: { mechanic_config: {}, content_config: { math: { sub_variant: "spatial_assembly" } } },
      3: { mechanic_config: {}, content_config: { math: { sub_variant: "spatial_assembly" } } },
      4: { mechanic_config: {}, content_config: { math: { sub_variant: "spatial_assembly" } } },
      5: { mechanic_config: {}, content_config: { math: { sub_variant: "spatial_assembly" } } },
      6: { mechanic_config: {}, content_config: { math: { sub_variant: "spatial_assembly" } } },
    }
  },
  ga_auditory_lab: {
    ...
    targetAccuracyLow: 0.65,
    levelMap: {
        1: { mechanic_config: {}, content_config: { math: { params: { digits: 2, speechRate: 1.0, pitchDelta: 800 } } } },
        2: { mechanic_config: {}, content_config: { math: { params: { digits: 2, speechRate: 1.2, pitchDelta: 700 } } } },
        3: { mechanic_config: {}, content_config: { math: { params: { digits: 3, speechRate: 1.0, pitchDelta: 600 } } } },
        4: { mechanic_config: {}, content_config: { math: { params: { digits: 3, speechRate: 1.2, pitchDelta: 500 } } } },
        5: { mechanic_config: {}, content_config: { math: { params: { digits: 3, speechRate: 1.5, pitchDelta: 400 } } } },
        6: { mechanic_config: {}, content_config: { math: { params: { digits: 4, speechRate: 1.2, pitchDelta: 300 } } } },
        7: { mechanic_config: {}, content_config: { math: { params: { digits: 4, speechRate: 1.5, pitchDelta: 250 } } } },
        8: { mechanic_config: {}, content_config: { math: { params: { digits: 5, speechRate: 1.5, pitchDelta: 200 } } } },
        9: { mechanic_config: {}, content_config: { math: { params: { digits: 5, speechRate: 1.8, pitchDelta: 150 } } } },
        10: { mechanic_config: {}, content_config: { math: { params: { digits: 6, speechRate: 1.8, pitchDelta: 100 } } } },
    }
  },
  glr_fluency_storm: {
  ...
  gc_verbal_inference: {
    ...
    targetAccuracyLow: 0.60,
    levelMap: {
      1: { mechanic_config: { timeLimit: 15000 }, content_config: { math: { params: { question_level: 1 } } } },
      2: { mechanic_config: { timeLimit: 15000 }, content_config: { math: { params: { question_level: 1 } } } },
      3: { mechanic_config: { timeLimit: 15000 }, content_config: { math: { params: { question_level: 1 } } } },
      4: { mechanic_config: { timeLimit: 15000 }, content_config: { math: { params: { question_level: 2 } } } },
      5: { mechanic_config: { timeLimit: 15000 }, content_config: { math: { params: { question_level: 2 } } } },
      6: { mechanic_config: { timeLimit: 15000 }, content_config: { math: { params: { question_level: 2 } } } },
      7: { mechanic_config: { timeLimit: 15000 }, content_config: { math: { params: { question_level: 3 } } } },
      8: { mechanic_config: { timeLimit: 15000 }, content_config: { math: { params: { question_level: 3 } } } },
      9: { mechanic_config: { timeLimit: 15000 }, content_config: { math: { params: { question_level: 3 } } } },
      10: { mechanic_config: { timeLimit: 15000 }, content_config: { math: { params: { question_level: 3 } } } },
    }
  },
  ef_focus_switch: {
