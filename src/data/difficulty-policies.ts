...
const policies: Partial<Record<GameId, DifficultyPolicy>> = {
  ...
  ef_focus_switch: {
    ...
    levelMap: {
      ...
      2: { mechanic_config: { switchProbability: 0.2, responseWindowMs: 2800 }, content_config: { math: { params: { ruleCount: 2, rules: ["parity", "magnitude"] } }, music: { sub_variant: 'auditory_go_no_go', params: { go_probability: 0.8, nogo_probability: 0.2, isi_ms: 1400, timbre_pair: ['sine', 'square'] } } } },
      3: { mechanic_config: { switchProbability: 0.25, responseWindowMs: 2800 }, content_config: { math: { params: { ruleCount: 2, rules: ["parity", "magnitude"] } }, music: { sub_variant: 'auditory_go_no_go', params: { go_probability: 0.78, nogo_probability: 0.22, isi_ms: 1400, timbre_pair: ['sine', 'triangle'] } } } },
      4: { mechanic_config: { switchProbability: 0.25, responseWindowMs: 2500 }, content_config: { math: { params: { ruleCount: 2, rules: ["parity", "magnitude"] } }, music: { sub_variant: 'auditory_go_no_go', params: { go_probability: 0.78, nogo_probability: 0.22, isi_ms: 1300, timbre_pair: ['sine', 'triangle'] } } } },
      5: { mechanic_config: { switchProbability: 0.3, responseWindowMs: 2500 }, content_config: { math: { params: { ruleCount: 2, rules: ["parity", "magnitude"] } }, music: { sub_variant: 'auditory_go_no_go', params: { go_probability: 0.75, nogo_probability: 0.25, isi_ms: 1300, timbre_pair: ['sine', 'triangle'] } } } },
      6: { mechanic_config: { switchProbability: 0.3, responseWindowMs: 2200 }, content_config: { math: { params: { ruleCount: 2, rules: ["parity", "magnitude"] } }, music: { sub_variant: 'auditory_go_no_go', params: { go_probability: 0.75, nogo_probability: 0.25, isi_ms: 1200, timbre_pair: ['sine', 'sawtooth'] } } } },
      7: { mechanic_config: { switchProbability: 0.35, responseWindowMs: 2200 }, content_config: { math: { params: { ruleCount: 2, rules: ["parity", "magnitude"] } }, music: { sub_variant: 'auditory_go_no_go', params: { go_probability: 0.72, nogo_probability: 0.28, isi_ms: 1200, timbre_pair: ['sine', 'sawtooth'] } } } },
      8: { mechanic_config: { switchProbability: 0.35, responseWindowMs: 2000 }, content_config: { math: { params: { ruleCount: 2, rules: ["parity", "magnitude"] } }, music: { sub_variant: 'auditory_go_no_go', params: { go_probability: 0.70, nogo_probability: 0.30, isi_ms: 1100, timbre_pair: ['sine', 'sawtooth'] } } } },
      9: { mechanic_config: { switchProbability: 0.4, responseWindowMs: 1800 }, content_config: { math: { params: { ruleCount: 2, rules: ["parity", "magnitude"] } }, music: { sub_variant: 'auditory_go_no_go', params: { go_probability: 0.70, nogo_probability: 0.30, isi_ms: 1000, timbre_pair: ['triangle', 'sawtooth'] } } } },
      10: { mechanic_config: { switchProbability: 0.4, responseWindowMs: 1800 }, content_config: { math: { params: { ruleCount: 2, rules: ["parity", "magnitude"] } }, music: { sub_variant: 'auditory_go_no_go', params: { go_probability: 0.68, nogo_probability: 0.32, isi_ms: 1000, timbre_pair: ['triangle', 'sawtooth'] } } } },
    }
  }
};
