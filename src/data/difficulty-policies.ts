...
const policies: Partial<Record<GameId, DifficultyPolicy>> = {
  ...
  gf_pattern_matrix: {
    ...
    levelMap: {
      1: { mechanic_config: { gridSize: "2x2", distractor_similarity: "low" }, content_config: { logic: { sub_variant: 'logic_matrix', params: {} }, neutral: { sub_variant: 'default', params: { rule: "shape" } }, math: { sub_variant: "deterministic", params: { rule: "arithmetic_sequence" } }, music: { sub_variant: 'melodic_pattern', params: { rule: 'transposition', complexity: 1 } }, verbal: { sub_variant: 'morphological_analogy', params: { type: "pseudo_word" } }, spatial: { sub_variant: 'assembly_logic', params: { rule: 'add_part' }}, eq: { sub_variant: 'emotion_matrix', params: { rule_family: ['Intensity'], distractor_count: 3 } } } },
      2: { mechanic_config: { gridSize: "2x2", distractor_similarity: "low" }, content_config: { logic: { sub_variant: 'logic_matrix', params: {} }, neutral: { sub_variant: 'default', params: { rule: "color" } }, math: { sub_variant: "deterministic", params: { rule: "geometric_sequence" } }, music: { sub_variant: 'melodic_pattern', params: { rule: 'transposition', complexity: 2 } }, verbal: { sub_variant: 'morphological_analogy', params: { type: "pseudo_word" } }, spatial: { sub_variant: 'assembly_logic', params: { rule: 'add_part_and_rotate' }}, eq: { sub_variant: 'emotion_matrix', params: { rule_family: ['Intensity'], distractor_count: 4 } } } },
      3: { mechanic_config: { gridSize: "3x3", distractor_similarity: "low" }, content_config: { logic: { sub_variant: 'logic_matrix', params: {} }, neutral: { sub_variant: 'default', params: { rule: "shape" } }, math: { sub_variant: "deterministic", params: { rule: "arithmetic_sequence" } }, music: { sub_variant: 'rhythmic_pattern', params: { rule: 'augmentation', complexity: 1 } }, verbal: { sub_variant: 'morphological_analogy', params: { type: "pseudo_word" } }, spatial: { sub_variant: 'assembly_logic', params: { rule: 'add_part' }}, eq: { sub_variant: 'emotion_matrix', params: { rule_family: ['Intensity', 'Valence Alternation'], distractor_count: 3 } } } },
      4: { mechanic_config: { gridSize: "3x3", distractor_similarity: "low" }, content_config: { logic: { sub_variant: 'logic_sequence', params: {} }, neutral: { sub_variant: 'default', params: { rule: "color" } }, math: { sub_variant: "deterministic", params: { rule: "geometric_sequence" } }, music: { sub_variant: 'melodic_pattern', params: { rule: 'inversion', complexity: 2 } }, verbal: { sub_variant: 'morphological_analogy', params: { type: "pseudo_word" } }, spatial: { sub_variant: 'assembly_logic', params: { rule: 'add_part_and_rotate' }}, eq: { sub_variant: 'emotion_matrix', params: { rule_family: ['Valence Alternation', 'Arousal Shift'], distractor_count: 4 } } } },
      5: { mechanic_config: { gridSize: "2x2", distractor_similarity: "medium" }, content_config: { logic: { sub_variant: 'logic_sequence', params: {} }, neutral: { sub_variant: 'default', params: { rule: "shape+color" } }, math: { sub_variant: "probabilistic", params: { samples: 5, populationSize: 30 } }, music: { sub_variant: 'harmony_logic', params: { rule: 'diatonic_progression', complexity: 1 } }, verbal: { sub_variant: 'morphological_analogy', params: { type: "pseudo_word_complex" } }, spatial: { sub_variant: 'vector_logic', params: { rule: 'translation' }}, eq: { sub_variant: 'emotion_matrix', params: { rule_family: ['Emotion Blending'], distractor_count: 5 } } } },
  ...
  gv_visual_lab: {
    ...
    targetAccuracyLow: 0.65,
    levelMap: {
      1: { mechanic_config: {}, content_config: { logic: { sub_variant: 'flowchart_tracer', params: { complexity: 'ifelse', nodeCount: 5 } }, eq: { params: { angles: [90, 180, 270], emotionFoil: false, distractorCount: 2 } }, neutral: { sub_variant: "mental_rotation", params: { angles: [90, 180, 270] } }, math: { sub_variant: "balance_puzzle", params: { shapeCount: 3, maxWeight: 5, equationTerms: 4 } }, music: { sub_variant: "contour_match", params: { measures: ['q_q_h', 'h_q_q'], distractorCount: 1 } }, verbal: { sub_variant: 'typographic_search', params: { type: 'compound', complexity: 1 } }, spatial: { sub_variant: 'spatial_assembly', params: { pieceCount: 5, complexity: 1 } } } },
      2: { mechanic_config: {}, content_config: { logic: { sub_variant: 'flowchart_tracer', params: { complexity: 'ifelse', nodeCount: 5 } }, eq: { params: { angles: [45, 90, 135, 180], emotionFoil: false, distractorCount: 2 } }, neutral: { sub_variant: "mental_rotation", params: { angles: [90, 180, 270] } }, math: { sub_variant: "balance_puzzle", params: { shapeCount: 3, maxWeight: 7, equationTerms: 5 } }, music: { sub_variant: "contour_match", params: { measures: ['q_q_h', 'h_q_q'], distractorCount: 2 } }, verbal: { sub_variant: 'typographic_search', params: { type: 'compound', complexity: 2 } }, spatial: { sub_variant: 'spatial_assembly', params: { pieceCount: 6, complexity: 1 } } } },
      3: { mechanic_config: {}, content_config: { logic: { sub_variant: 'flowchart_tracer', params: { complexity: 'ifelse', nodeCount: 6 } }, eq: { params: { angles: [45, 90, 135, 180, 225, 270], emotionFoil: true, distractorCount: 4 } }, neutral: { sub_variant: "mental_rotation", params: { angles: "free" } }, math: { sub_variant: "balance_puzzle", params: { shapeCount: 4, maxWeight: 7, equationTerms: 5 } }, music: { sub_variant: "contour_match", params: { measures: ['q_q_h', 'h_q_q', 'e_e_q_q'], distractorCount: 2 } }, verbal: { sub_variant: 'typographic_search', params: { type: 'affixes', complexity: 1 } }, spatial: { sub_variant: 'spatial_assembly', params: { pieceCount: 7, complexity: 2 } } } },
      4: { mechanic_config: {}, content_config: { logic: { sub_variant: 'flowchart_tracer', params: { complexity: 'loop', nodeCount: 6, iterations: 2 } }, eq: { params: { angles: [45, 90, 135, 180, 225, 270, 315], emotionFoil: true, distractorCount: 4 } }, neutral: { sub_variant: "mental_rotation", params: { angles: "free" } }, math: { sub_variant: "balance_puzzle", params: { shapeCount: 4, maxWeight: 9, equationTerms: 6 } }, music: { sub_variant: "contour_match", params: { measures: ['q_q_h', 'h_q_q', 'e_e_q_q'], distractorCount: 3 } }, verbal: { sub_variant: 'typographic_search', params: { type: 'affixes', complexity: 2 } }, spatial: { sub_variant: 'spatial_assembly', params: { pieceCount: 8, complexity: 2 } } } },
      5: { mechanic_config: {}, content_config: { logic: { sub_variant: 'flowchart_tracer', params: { complexity: 'loop', nodeCount: 7, iterations: 3 } }, eq: { params: { angles: [45, 90, 135, 180, 225, 270, 315], emotionFoil: true, distractorCount: 4 } }, neutral: { sub_variant: "mental_rotation", params: { angles: "free", reflection: true } }, math: { sub_variant: "balance_puzzle", params: { shapeCount: 5, maxWeight: 9, equationTerms: 6 } }, music: { sub_variant: "spectrogram_match", params: { timbres: ['sine', 'square'], distractorCount: 3 } }, verbal: { sub_variant: 'visual_scan', params: { grid_size: 5, target_length: 3 } }, spatial: { sub_variant: 'spatial_assembly', params: { pieceCount: 9, complexity: 3 } } } },
      6: { mechanic_config: {}, content_config: { logic: { sub_variant: 'flowchart_tracer', params: { complexity: 'loop', nodeCount: 7, iterations: 4 } }, neutral: {}, math: { sub_variant: "balance_puzzle", params: { shapeCount: 5, maxWeight: 12, equationTerms: 7 } }, music: {}, verbal: {}, spatial: { sub_variant: 'spatial_assembly', params: { pieceCount: 10, complexity: 3 } } } },
      7: { mechanic_config: {}, content_config: { logic: { sub_variant: 'flowchart_tracer', params: { complexity: 'nested', nodeCount: 8 } }, spatial: { sub_variant: 'spatial_assembly', params: { pieceCount: 11, complexity: 4 } } } },
      8: { mechanic_config: {}, content_config: { logic: { sub_variant: 'flowchart_tracer', params: { complexity: 'nested', nodeCount: 10 } }, spatial: { sub_variant: 'spatial_assembly', params: { pieceCount: 12, complexity: 4 } } } },
    }
  },
  ga_auditory_lab: {
  ...
  ef_focus_switch: {
    ...
    levelMap: {
      1: { mechanic_config: { switchProbability: 0.3, noGo: false, responseWindowMs: 3000 }, content_config: { logic: { sub_variant: 'rule_switcher', params: {} }, neutral: { params: { ruleCount: 2, rules: ["position", "arrow"] } }, math: { params: { ruleCount: 2, rules: ["parity", "magnitude"] } }, music: { sub_variant: 'auditory_stroop', params: { incongruent_ratio: 0.25, high_pitch_hz: 300, low_pitch_hz: 150 } }, verbal: { sub_variant: 'semantic_phonetic_shift', params: { rules: ['rhyme', 'category'], switch_interval: 10 } }, spatial: { sub_variant: 'perspective_shift', params: { cue: 'explicit' } }, eq: { params: { ruleCount: 2, rules: ["emotion", "gaze"], incongruent_ratio: 0.1 } } } },
      2: { mechanic_config: { switchProbability: 0.3, responseWindowMs: 2800 }, content_config: { logic: { sub_variant: 'rule_switcher', params: {} }, math: { params: { ruleCount: 2, rules: ["parity", "magnitude"] } }, music: { sub_variant: 'auditory_stroop', params: { incongruent_ratio: 0.25, high_pitch_hz: 280, low_pitch_hz: 160 } }, eq: { params: { ruleCount: 2, rules: ["emotion", "gaze"], incongruent_ratio: 0.15 } } } },
      3: { mechanic_config: { switchProbability: 0.3, responseWindowMs: 2800 }, content_config: { logic: { sub_variant: 'rule_switcher', params: {} }, math: { params: { ruleCount: 2, rules: ["parity", "magnitude"] } }, music: { sub_variant: 'auditory_go_no_go', params: { go_probability: 0.78, nogo_probability: 0.22, isi_ms: 1400 } }, eq: { params: { ruleCount: 2, rules: ["emotion", "gaze"], incongruent_ratio: 0.2 } } } },
      4: { mechanic_config: { switchProbability: 0.3, responseWindowMs: 2500 }, content_config: { logic: { sub_variant: 'rule_switcher', params: {} }, math: { params: { ruleCount: 2, rules: ["parity", "magnitude"] } }, music: { sub_variant: 'auditory_stroop', params: { incongruent_ratio: 0.30, high_pitch_hz: 260, low_pitch_hz: 170 } }, eq: { params: { ruleCount: 2, rules: ["emotion", "gaze"], incongruent_ratio: 0.25 } } } },
      5: { mechanic_config: { switchProbability: 0.35, responseWindowMs: 2500 }, content_config: { logic: { sub_variant: 'rule_switcher', params: {} }, math: { params: { ruleCount: 2, rules: ["parity", "magnitude"] } }, music: { sub_variant: 'auditory_go_no_go', params: { go_probability: 0.75, nogo_probability: 0.25, isi_ms: 1300 } }, eq: { params: { ruleCount: 2, rules: ["emotion", "gaze"], incongruent_ratio: 0.3 } } } },
      6: { mechanic_config: { switchProbability: 0.35, responseWindowMs: 2200 }, content_config: { logic: { sub_variant: 'rule_switcher', params: {} }, math: { params: { ruleCount: 2, rules: ["parity", "magnitude"] } }, music: { sub_variant: 'auditory_stroop', params: { incongruent_ratio: 0.35, high_pitch_hz: 240, low_pitch_hz: 180 } }, eq: { params: { ruleCount: 2, rules: ["emotion", "gaze"], incongruent_ratio: 0.35 } } } },
      7: { mechanic_config: { switchProbability: 0.35, responseWindowMs: 2200 }, content_config: { logic: { sub_variant: 'rule_switcher', params: {} }, math: { params: { ruleCount: 2, rules: ["parity", "magnitude"] } }, music: { sub_variant: 'auditory_go_no_go', params: { go_probability: 0.72, nogo_probability: 0.28, isi_ms: 1200 } }, eq: { params: { ruleCount: 2, rules: ["emotion", "gaze"], incongruent_ratio: 0.4 } } } },
      8: { mechanic_config: { switchProbability: 0.4, responseWindowMs: 2000 }, content_config: { logic: { sub_variant: 'rule_switcher', params: {} }, math: { params: { ruleCount: 2, rules: ["parity", "magnitude"] } }, music: { sub_variant: 'auditory_stroop', params: { incongruent_ratio: 0.40, high_pitch_hz: 220, low_pitch_hz: 190 } }, eq: { params: { ruleCount: 2, rules: ["emotion", "gaze"], incongruent_ratio: 0.5 } } } },
    }
  }
};
