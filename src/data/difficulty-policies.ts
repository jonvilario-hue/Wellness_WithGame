...
const policies: Partial<Record<GameId, DifficultyPolicy>> = {
  ...
  gf_pattern_matrix: {
    ...
    levelMap: {
      ...
      6: { mechanic_config: { gridSize: "2x2", distractor_similarity: "medium" }, content_config: { eq: { sub_variant: 'emotion_matrix', params: { rule_family: ['Emotion Blending', 'Context Negation'], distractor_count: 5 } } } },
      7: { mechanic_config: { gridSize: "3x3", distractor_similarity: "medium" }, content_config: { eq: { sub_variant: 'emotion_matrix', params: { rule_family: ['Intensity', 'Valence Alternation', 'Emotion Blending'], distractor_count: 6 } } } },
      8: { mechanic_config: { gridSize: "3x3", distractor_similarity: "medium" }, content_config: { eq: { sub_variant: 'emotion_matrix', params: { rule_family: ['Arousal Shift', 'Context Negation', 'Emotion Blending'], distractor_count: 6 } } } },
    }
  },
  gv_visual_lab: {
