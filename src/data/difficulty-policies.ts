...
const policies: Partial<Record<GameId, DifficultyPolicy>> = {
  ...
  ef_focus_switch: {
    ...
    levelMap: {
      1: { mechanic_config: { switchProbability: 0.2, noGo: false, responseWindowMs: 3000 }, content_config: { neutral: { params: { ruleCount: 2, cueType: "explicit_text" } }, math: { params: { ruleCount: 2, rules: ["parity", "magnitude"] } }, music: { sub_variant: 'task_switching', params: { csi_ms: 1000, high_pitch_hz: 880, low_pitch_hz: 440, long_duration_ms: 700, short_duration_ms: 300 } }, verbal: { sub_variant: 'semantic_phonetic_shift', params: { rules: ['rhyme', 'category'], switch_interval: 10 } }, spatial: { sub_variant: 'perspective_shift', params: { cue: 'explicit' } } } },
      2: { mechanic_config: { switchProbability: 0.2, responseWindowMs: 2800 }, content_config: { math: { params: { ruleCount: 2, rules: ["parity", "magnitude"] } }, music: { sub_variant: 'task_switching', params: { csi_ms: 900, high_pitch_hz: 880, low_pitch_hz: 440, long_duration_ms: 700, short_duration_ms: 300 } } } },
      3: { mechanic_config: { switchProbability: 0.25, responseWindowMs: 2800 }, content_config: { math: { params: { ruleCount: 2, rules: ["parity", "magnitude"] } }, music: { sub_variant: 'task_switching', params: { csi_ms: 800, high_pitch_hz: 784, low_pitch_hz: 440, long_duration_ms: 650, short_duration_ms: 350 } } } },
      4: { mechanic_config: { switchProbability: 0.25, responseWindowMs: 2500 }, content_config: { math: { params: { ruleCount: 2, rules: ["parity", "magnitude"] } }, music: { sub_variant: 'task_switching', params: { csi_ms: 700, high_pitch_hz: 784, low_pitch_hz: 440, long_duration_ms: 650, short_duration_ms: 350 } } } },
      5: { mechanic_config: { switchProbability: 0.3, responseWindowMs: 2500 }, content_config: { math: { params: { ruleCount: 2, rules: ["parity", "magnitude"] } }, music: { sub_variant: 'task_switching', params: { csi_ms: 600, high_pitch_hz: 698, low_pitch_hz: 440, long_duration_ms: 600, short_duration_ms: 400 } } } },
      6: { mechanic_config: { switchProbability: 0.3, responseWindowMs: 2200 }, content_config: { math: { params: { ruleCount: 2, rules: ["parity", "magnitude"] } }, music: { sub_variant: 'task_switching', params: { csi_ms: 500, high_pitch_hz: 698, low_pitch_hz: 440, long_duration_ms: 600, short_duration_ms: 400 } } } },
      7: { mechanic_config: { switchProbability: 0.35, responseWindowMs: 2200 }, content_config: { math: { params: { ruleCount: 2, rules: ["parity", "magnitude"] } }, music: { sub_variant: 'auditory_stroop', params: { incongruent_ratio: 0.25, high_pitch_hz: 659, low_pitch_hz: 440 } } } },
      8: { mechanic_config: { switchProbability: 0.35, responseWindowMs: 2000 }, content_config: { math: { params: { ruleCount: 2, rules: ["parity", "magnitude"] } }, music: { sub_variant: 'auditory_stroop', params: { incongruent_ratio: 0.30, high_pitch_hz: 659, low_pitch_hz: 466 } } } },
      9: { mechanic_config: { switchProbability: 0.4, responseWindowMs: 1800 }, content_config: { math: { params: { ruleCount: 2, rules: ["parity", "magnitude"] } }, music: { sub_variant: 'auditory_stroop', params: { incongruent_ratio: 0.35, high_pitch_hz: 587, low_pitch_hz: 493 } } } },
      10: { mechanic_config: { switchProbability: 0.4, responseWindowMs: 1800 }, content_config: { math: { params: { ruleCount: 2, rules: ["parity", "magnitude"] } }, music: { sub_variant: 'auditory_stroop', params: { incongruent_ratio: 0.40, high_pitch_hz: 587, low_pitch_hz: 523 } } } },
    }
  }
};
